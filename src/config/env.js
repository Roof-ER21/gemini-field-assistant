...
export const env = {
    ...
    // Environment
    IS_PRODUCTION: getEnvVar('RAILWAY_ENVIRONMENT') === 'production' || (typeof import.meta.env !== 'undefined' && import.meta.env.PROD),
    IS_DEVELOPMENT: !(typeof import.meta.env !== 'undefined' && import.meta.env.PROD),
    // Logging
    get isDevelopment() {
