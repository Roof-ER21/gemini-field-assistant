...
import { pc, sec, loadContent, markEm } from './leadContent.js';
// ---------------------------------------------------------------------------
...
function renderReferralPage(referRep, code, rep, content) {
    ...
    const repTitle = referRep?.rep_title || 'Roofing Specialist';
    const repPhone = referRep?.rep_phone || '';
    const repImage = referRep?.image_url || '';
...
// ---------------------------------------------------------------------------
function renderFreeInspectionPage(rep, content) {
