 ...
 */
export async function loadTiersFromDatabase(pool) {
    const now = Date.now();
 ...
 */
export async function calculateBonusTier(signups, pool) {
 ...
 */
export async function calculateBonusTierNumber(signups, pool) {
    const tiers = await loadTiersFromDatabase(pool);
 ...
 */
export function calculateBonusTierSync(signups) {
 ...
 */
export async function getAllTiers(pool) {
