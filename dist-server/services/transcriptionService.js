 ...
 */
export async function stopRecording(state) {
 ...
 * Pause recording
 */
export function pauseRecording(state) {
 ...
 * Resume recording
 */
export function resumeRecording(state) {
 ...
 */
export async function transcribeAudio(audioBlob, meetingType = 'other') {
 ...
 */
function parseTranscriptSegments(transcription) {
    const segments = [];
 ...
 */
function generateTitle(customerName, propertyAddress, meetingType = 'other') {
 ...
 */
export function getSavedTranscripts() {
 ...
 */
export function cleanupRecording(state) {
    if (state.mediaRecorder) {
 ...
 */
export function exportTranscriptAsMarkdown(transcript) {
