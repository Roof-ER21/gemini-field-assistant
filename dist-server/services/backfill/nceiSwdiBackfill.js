...
function coarseStateFromLatLng(lat, lng) {
    ...
    if (lat >= 37.2 && lat <= 40.6 && lng >= -82.6 && lng <= -77.7)
        return 'WV';
    // DE: ~38.5-39.8N, -75.8 to -75.0
    if (lat >= 38.5 && lat <= 39.8 && lng >= -75.8 && lng <= -75.0)
        return 'DE';
        ...
        for (const dataset of datasets) {
            ...
            while (cursor < end) {
                ...
                try {
                    ...
                    onProgress?.({
                        source: 'ncei_swdi', phase: 'fetching',
