 ...
 */
async function resolveYearFile(type, year) {
        ...
        for (const t of types) {
            for (let year = startYear; year <= endYear; year++) {
                ...
                try {
                    ...
                    if (!resp.ok)
                        throw new Error(`SPC ${t} ${year} HTTP ${resp.status}`);
                    ...
                    for (const r of filtered) {
                        ...
                        if (hailSize == null && windMph == null && tornadoEfRank == null)
                            continue;
                        batch.push({
                            eventDate,
                            latitude: lat,
