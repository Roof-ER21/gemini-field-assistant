...
export const documentSanitizer = {
     ...
     */
    sanitizeContent(content, documentName) {
        const issues = [];
    ...
    isDisplayableText(content) {
        ...
        if (content.includes('\0'))
            return false;
        if (content.includes('PK\x03\x04'))
            return false;
     ...
     */
    getCleanPreview(content, maxLength = 500) {
