...
export class ChatMonitorService {
     ...
     */
    detectStateMismatch(content, userState) {
     ...
     */
    detectCompetitorMention(content) {
        const contentLower = content.toLowerCase();
     ...
     */
    analyzeConversation(messages, userState) {
        const detections = [];
     ...
     */
    getConcernTypeLabel(concernType) {
        const labels = {
