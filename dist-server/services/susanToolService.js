...
const lookupHailDataDeclaration = {
    ...
    description: 'Search IHM (Interactive Hail Maps) hail history for a specific address. Returns hail and wind events with dates, sizes, and severity. Use when the rep or a homeowner asks about storm history at a property.',
    parameters: {
        type: Type.OBJECT,
        properties: {
            street: {
