 ...
 */
import pg from 'pg';
import { createStormMemoryService } from './stormMemoryService.js';
const { Pool } = pg;
async function testStormMemoryService() {
    ...
    try {
        ...
        const updated = await service.recordOutcome(lookup1.id, 'claim_won', 'Approved for $25,000 roof replacement');
