        ...
        if (hasWarnings || hasLegacyNexrad) {
            ...
            if (warningCount > 0) {
                doc.fontSize(9).fillColor(this.C.text).font('Helvetica')
                    .text(`At the approximate time of the hail impact, the property located at ${input.address} was under multiple severe weather warnings issued by the National Weather Service, as follows:`, this.M + 20, doc.y, { width: this.CW - 40, lineGap: 2 });
                doc.moveDown(0.8);
            }
