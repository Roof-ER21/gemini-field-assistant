                ...
                <div key={u.id} className="roof-er-doc-card" style={{ position: 'relative' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', marginTop: '8px' }}>
                    ...
                    <button
                      onClick={() => {
                        try {
                          // Navigate user to Knowledge panel via localStorage marker
                          localStorage.setItem('knowledge_open_doc', u.path);
                          alert('Open this file in Knowledge from the sidebar.');
                        } catch {}
                      }}
