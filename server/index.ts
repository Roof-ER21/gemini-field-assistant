...
function calculateBonusTier(signups: number): { tier: number; name: string; color: string; bonus: number; nextTier: { name: string; signupsNeeded: number; bonus: number } | null } {
