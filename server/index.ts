...
function calculateBonusTier(signups: number): { tier: number; name: string; color: string; bonusDisplay: string; nextTier: { name: string; signupsNeeded: number; bonusDisplay: string } | null } {
