...
export function createAgentTokenRouter(pool: pg.Pool): Router {
  const router = Router();

  router.use((req: SessionRequest, res: Response, next) => {
  ...
  router.get('/', async (req: SessionRequest, res: Response) => {
    try {
      ...
      console.error('[agent-tokens] list failed:', (err as Error).message);
  ...
  router.post('/', async (req: SessionRequest, res: Response) => {
    ...
    try {
      ...
      console.error('[agent-tokens] create failed:', (err as Error).message);
  ...
  router.delete('/:id', async (req: SessionRequest, res: Response) => {
    try {
      ...
      console.error('[agent-tokens] revoke failed:', (err as Error).message);
